...
**Task** Run the following code and describe the dataframe it outputs. **Answer The dataframe contains 50 rows, with each row representing a different state. Each of the five fields listed above have a value with each state.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer There seems to be an even distribution around the line of best fit.**
...
**Task** Run the following code. Describe the plot. What do you see? **Answer Most of the data points fall short of the 20000 mark, but the distribution around the line of best fit still appears to be even.**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer Since all of the values are negative, this indicates that there is a negative correlation. But since these values aren't quite negative, they might not be considered to be strong.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer The model gives an alternate hypothesis, a value for the confidence interval, and sample estimates.**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer The output gives a p-value, an alternative hypothesis, a confidence interval and sample estimates. The correlation is -0.05, which is negative but relatively week.**
...
**Task** Run the following code. Describe the table. What do you see? **Answer Biden has a higher mean GDP and mean education per pupil. Trump has a higher mean population growth.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer There are t and p-values given, along with an alternative hypothesis, confidence interval and sample estimates. The t-value is -1.828, and the p-value is 0.07411.**
...
**Task** Run the following code. Describe the output. What do you see? **Answer There are t and p-values given, a df, along with an alternative hypothesis, confidence interval and sample estimates. The t-value is strong at 4.2494, and the p-value is low at 0.0001289. The df equals 39.029.**
**
