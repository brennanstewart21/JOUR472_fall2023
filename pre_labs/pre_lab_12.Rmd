...
**Task** Run the following code and describe the dataframe it outputs. **Answer The dataframe contains information including the date, title, URL, and specific text. There are a total of 999 entries.**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer The function creates a new list of unique words that contains the words specifically entered in the code.**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer A list of 647,000 unique words is given, each word having its own row.**
...
**Task** Run the following code and describe what the resulting graphic shows. Is it interesting? **Answer The graphic is a bar graph that counts each time a unique word was said in Cardin's releases. The graph then lists these words from most occurring to least occurring.**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer The data is more interesting than before, as it filters out unique words that have very little meaning. The new words are more specific to what the releases are about.**
...
**Task** Run the following code and describe the results. **Answer Each unique_words dataset contains thousands of unique words. While 2023 only has 70,000 unique words, 2021 and 2022's datasets each exceed 200,000.**
...
**Task** Run the following code and describe the results. **Answer Covid 19 is listed as the most frequent bigram with 576 results. Human rights and "19 pandemic" follow behind, each with over 200 counts. **
...
**Task** Run the following code and describe the results. **Answer Project location is the most frequent bigram with 434 occurrences, followed by amount included at 283.**
...
**Task** Run the following code and describe the results. **Answer Human rights is listed with the most at 50 occurrences, followed by equal rights (41) and health care (40).**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer I agree with all of the sentiments in the 2021 and 2022 data sets. Critical was the main one that stuck out to me, but I understand its negative connotation.**
