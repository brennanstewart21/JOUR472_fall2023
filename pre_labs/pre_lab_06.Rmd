...
**Task** Load the four CSV population estimate files. Do they have the same column structure? **Answer They have the same column names, but they are ordered differently going across.**
...
**Task** Run the following code to filter on Frederick County's registration data and look at the results. What stands out to you about the changes in party registration over time? **Answer The number of Democrats rises significantly by 18000, Republican registration raises by 4000, and the unaffiliated registrant count raises by 13000. The total number of registrants rises by roughly 20000 as well.**
...
**Task** Load the Maryland demographic data and examine it. What kind of information does it contain? **Answer The data groups Maryland's population by race for each county and also by those who are over the age of 18.**
...
**Task** Using mutate, let's find the county with the highest 18+ Black population as a percentage of all population 18 and over and also the percentage of Democrats in that county. Put your answers below. **Answer The county with the highest 18+ Black population is Prince George's County. The county with the highest percentage of Democrats is also Prince George's County with 77%.**
...
**Task** Now let's find the county with the highest 18+ Asian population as a percentage of all population 18 and over and also the percentage of Democrats in that county. How do these results compare to the previous task? Put your answers below. **Answer Howard County is the county with the highest 18+ Asian population, but its percentage of registered Democrats is lower than Prince George's County at 52.6%.**
...
**Task** Run the following code to load the Zip Code Tabulation Area data for Maryland. What's the datatype of the ZCTA5N column? **Answer \<dbl\> or double class.**
...
**Task** Run the following code to change the datatype of ZCTA5N from numeric to character. What's the datatype of ZCTA5N? **Answer \<chr\> or character.**
