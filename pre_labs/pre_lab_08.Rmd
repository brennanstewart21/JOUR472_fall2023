...
**Task** Run the following code to load the data. In the space below, indicate how many rows and columns it has. **Answer 4 columns, 3822 rows**
...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer The mutate function is creating a column that takes the month out of the listed dates. The group_by function is grouping the number of calls together by month, and the summarize function is adding the total number of calls together for each month.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A grey box with no data displayed.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A bar graph that shows the number of calls on the y-axis and the months along the x-axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The months are arranged in order from lowest count to highest count.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The months are now along the y-axis while the call values run along the x-axis. The bar graph has essentially been flipped 90 degrees.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The background color has changed from grey to white.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer The background is now blue. The chart has less of a grid in the background and now only has horizontal lines.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer The axis labels have been cleaned up, and a title has been added to the graph..**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The dates are listed in chronological order.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer A line graph is displayed with very small intervals.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The dates are grouped by week, rather than month. It is impossible to read the intervals along the x-axis.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer The weeks have been angled along the x-axis so they are easier to read.**
