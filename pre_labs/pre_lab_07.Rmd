...
```{r echo=FALSE}
census_api_key("1117de07e74e56cc5cc7154151e5d3e0fd59aff5", install=TRUE)
```
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer Highest median household income by county in Maryland**
...
**Task** Let's look at the average household income for high schools that have 60% or more graduates immediately enrolling in college, and then look at those with less than 40%. Write a sentence describing the results. **Answer Fifty high schools in Maryland have 60% or more graduates enrolling in college, while 76 high schools have less than 40% of their students enrolling in college.**
...
**Task** What is another question you could ask of this data? **Answer Of the high schools with less than a 50% college enrollment rate, which have the highest median household incomes?**
