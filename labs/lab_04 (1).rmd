...
**A2. Jain ran in the Democratic primary for U.S. House Maryland District 6. Billy Bonniface ran as the republican candidate for Harford County Executive. Peter Franchot is a former comptroller of Maryland.**
...
**A3. Governor Wes Moore is missing from the A1 list. There were Facebook ads for Wes Moore according to the ad library, however. SKDK is the biggest recipient of media expenses by Wes Moore.**
...
**A4. Friends of Jashwani Jain appears to have spent all of their online advertising dollars on Facebook**

```{r}

media_expenses |> 
  filter(expense_purpose == 'Online Advertising' | payee_name == 'Facebook') |>
  group_by(committee_name) |>
  arrange(desc(amount))
...
**A5 There is a decent amount of information that is given with the data. The best story idea I've thought of so far is analyzing the dates of when these expenses were paid in order to see how political candidates increased or decreased their spending as their campaigns progressed.**
