...
A3.The original data does not include zip codes, only the first line of the street addresses. This could skew the counts if there were calls at different locations that contain the same street addresses. 
