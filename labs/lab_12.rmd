...
```{r}
#Load the data
md_attorney_sanctions <- read_csv("md_attorney_sanctions.csv")
```
...
**A1. The leading word is "failing," which comes in at a count of 1571. The other words in the top 10 are things like "client," "attorney," "respondent," "trust" and "account." These words are describing the parties involved with the misconduct that's carried out by attorneys.**
...
**A2. The top trigram is "attorney trust account," which appears 343 times. In legal terms, this is a bank account where a client's funds are kept until it is time for them to be withdrawn.**
...
**A3. There is a noticably big dip between 2017 and 2018, but then the number spikes back up again in 2019 and stays above 25 thereafter. To look at the most important reasons that attorneys get sanctioned, you could look at any unreasonable fees that were given to clients.** The fiscal year which mentions the term "attorney trust account" the most in its sanctions is 2021, with the term appearing 37 times and accounting for 19.577% of all times the term was said in the sanctions since 2011. This leads me to believe that many people had funds in their attorney trust accounts in 2021 as a consequence of the COVID-19 pandemic, and one of the most common infractions for lawyers to commit is stealing escrow funds from their clients' accounts. So it is possible that many lawyers in practice were stealing funds and exploiting those who were disadvantaged (particularly families and businesses) during the pandemic.
